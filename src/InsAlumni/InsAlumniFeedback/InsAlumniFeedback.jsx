...
import style from "./InsAlumniFeedback.module.css";
...
function AlumniFeedback({ aid, setStatus, feedbacks, rating }) {
  ...
  }, [page, aid, search, getFeedbackListRefetch]);
          ...
          <div className={style.prominentAlumnitoptext}>
            <div className={style.prominentAlumnitoptexttop}>
              ...
              <p className={style.prominentAlumnitoptextp}>
                {t("feed_received")} <span>{feedbacks}</span>{" "}
              </p>
            </div>
            <h6 className={style.prominentAlumnitoptexth6}>
