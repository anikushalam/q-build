...
function ConfirmStudentAdmisionModal({
  addDisplay,
  hideModal,
  statusQuery,
  ...
  const [studentPayMode] = useStudentPayMode();
  ...
  const { merchantId, merchantIdRefetch } = useMerchantId({
    id: oneApplicationDetail?.oneApply?.admissionAdmin?.institute?._id,
    skip: !oneApplicationDetail?.oneApply?.admissionAdmin?.institute?._id,
  });
  useEffect(() => {
    if (statusQuery?.applicationId?._id) oneApplicationDetailRefetch();
  }, [statusQuery?.applicationId?._id, oneApplicationDetailRefetch]);
  useEffect(() => {
    if (oneApplicationDetail?.oneApply?.admissionAdmin?.institute?._id)
      merchantIdRefetch();
  }, [
    oneApplicationDetail?.oneApply?.admissionAdmin?.institute?._id,
    merchantIdRefetch,
  ]);
  ...
  useEffect(() => {
    setAllContent((prev) => ({
      ...prev,
      amount: statusQuery?.feeStructure?.applicable_fees,
      // amount: statusQuery?.feeStructure?.one_installments?.fees,
    }));
  }, [statusQuery?.feeStructure?.applicable_fees]);
  ...
  const ConfirmOffline = () => {
    ...
    if (data?.sid !== "" && data?.aid !== "" && data?.statusId !== "") {
      if (statusQuery?.flow_status === "Hostel Application") {
  ...
  // console.info("hjsdfjsdfsdm", statusQuery);
    ...
    if (is_paytm === "PAYTM") {
      if (statusQuery?.flow_status === "Hostel Application") {
        ...
        get_initiate_paytm({
          ...
          type: "Admission",
          paidBy: `${statusQuery?.studentId}`,
          paidTo: `${oneApplicationDetail?.oneApply?.admissionAdmin?.institute?._id}`,
          moduleId: `${statusQuery?.applicationId?._id}`,
          ad_status_id: statusQuery?._id,
          payment_installment: allContent.installmentType,
          ad_install: install,
            ...
            .then((res) => {
              if (res.data?.success) {
                payment_initiating_set({
                  ...
                  type: "Admission",
                  pay_by: `${statusQuery?.studentId}`,
                  pay_to: `${oneApplicationDetail?.oneApply?.admissionAdmin?.institute?._id}`,
                  mid: `${statusQuery?.applicationId?._id}`,
                  razor_key: merchantId?.key,
                  razor_author: merchantId?.bool,
                  status: statusQuery?._id,
  ...
  const onConfirmFeeStrucutre = (structure, flowStatus) => {
    if (flowStatus === "Hostel Application") {
      if (
                ...
                <div className={style.content}>
                  ...
                  {index === 0 && (
                    <div>
                      <div className={style.singlerow}>
                        ...
                        <h6>
                          Rs.{" "}
                          {statusQuery?.feeStructure?.total_admission_fees ??
                      ...
                      <div className={style.singlerow}>
                        <h6>
                          {t("fees_category")} {" : "}
                          {statusQuery?.feeStructure?.category_master
                            ?.category_name ??
                      ...
                      {install && (
                        <div>
                          ...
                          <div className={style.singlerow1}>
                            ...
                            <h6>
                              Rs.{" "}
                              {statusQuery?.feeStructure?.one_installments
                                ?.fees ??
                                statusQuery?.hostel_fee_structure
                          ...
                          {statusQuery?.feeStructure?.two_installments?.fees ? (
                            <div className={style.singlerow1}>
                              <h6>{t("two_installments")}</h6>
                              <h6>
                                Rs.{" "}
                                {statusQuery?.feeStructure?.two_installments
                                  ?.fees ?? 0}
                              </h6>
                            </div>
                          ) : (
                          ...
                          {statusQuery?.feeStructure?.three_installments
                            ?.fees ? (
                            <div className={style.singlerow1}>
                          ...
                          {statusQuery?.feeStructure?.four_installments
                            ?.fees ? (
                            <div className={style.singlerow1}>
                          ...
                          {statusQuery?.feeStructure?.five_installments
                            ?.fees ? (
                            <div className={style.singlerow1}>
                          ...
                          {statusQuery?.feeStructure?.six_installments?.fees ? (
                            <div className={style.singlerow1}>
                              <h6>{t("six_installments")}</h6>
                              <h6>
                                Rs.{" "}
                                {statusQuery?.feeStructure?.six_installments
                                  ?.fees ?? 0}
                              </h6>
                            </div>
                          ) : (
                          ...
                          {statusQuery?.feeStructure?.seven_installments
                            ?.fees ? (
                            <div className={style.singlerow1}>
                          ...
                          {statusQuery?.feeStructure?.eight_installments
                            ?.fees ? (
                            <div className={style.singlerow1}>
                          ...
                          {statusQuery?.feeStructure?.nine_installments
                            ?.fees ? (
                            <div className={style.singlerow1}>
                          ...
                          {statusQuery?.feeStructure?.ten_installments?.fees ? (
                            <div className={style.singlerow1}>
                              <h6>{t("ten_installments")}</h6>
                              <h6>
                                Rs.{" "}
                                {statusQuery?.feeStructure?.ten_installments
                                  ?.fees ?? 0}
                              </h6>
                            </div>
                          ) : (
                          ...
                          {statusQuery?.feeStructure?.eleven_installments
                            ?.fees ? (
                            <div className={style.singlerow1}>
                          ...
                          {statusQuery?.feeStructure?.tweleve_installments
                            ?.fees ? (
                            <div className={style.singlerow1}>
                      ...
                      <div
                        ...
                        style={{ cursor: "pointer" }}
                        onClick={() =>
                          statusQuery?.flow_status === "Hostel Application"
                            ? onConfirmFeeStrucutre(
                                statusQuery?.hostel_fee_structure,
                                statusQuery?.flow_status
                              )
                            : onConfirmFeeStrucutre(
                                statusQuery?.feeStructure,
                                statusQuery?.flow_status
                              )
                        }
                      >
                  ...
                  {index === 1 && (
                    <div>
                      ...
                      {statusQuery?.feeStructure?.one_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("first_install")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      {statusQuery?.feeStructure?.three_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("three_installments")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      {statusQuery?.feeStructure?.four_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("four_installments")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      {statusQuery?.feeStructure?.five_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("five_installments")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      {statusQuery?.feeStructure?.seven_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("seven_installments")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      {statusQuery?.feeStructure?.eight_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("eight_installments")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      {statusQuery?.feeStructure?.nine_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("nine_installments")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      {statusQuery?.feeStructure?.eleven_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("eleven_installments")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      {statusQuery?.feeStructure?.tweleve_installments?.fees ? (
                        <div className={style.singlerow1}>
                          <h6>{t("tweleve_installments")}</h6>
                          <h6>
                            Rs.{" "}
                      ...
                      <StudentPaymentGateway
                        ...
                        setIndex={setIndex}
                        departmentId={
                          statusQuery?.applicationId?.applicationDepartment ??
                        ...
                        flowAs={
                          statusQuery?.applicationId?.applicationDepartment
                            ? "Department"
                            : statusQuery?.applicationId?.applicationUnit
                                ?.hostel?._id
                            ? "Hostel"
                            : ""
                        }
...
export default ConfirmStudentAdmisionModal;
