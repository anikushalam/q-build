...
const NEFTProcess = ({
  ...
  // console.info("this is uopi,", getBankByFinance);
  return (
    <div
      ...
      {!openForm ? (
        <>
          ...
          <section className={style.process_description}>
            <h6>{t("procedure_for_paying_in_neft")}</h6>
            <p>1. {t("visit_your_bank")} </p>
            <p>2. {t("by_entering_bank")}</p>
            <p>3. {t("find_school_college")}</p>
            <p>4. {t("after_payment_made_is")}</p>
            <p>5. {t("after_payment_made_and_authorised")}</p>
          </section>
        ...
        <PaymentForm
          ...
          activePaymentStatus="NEFT/RTGS/IMPS"
