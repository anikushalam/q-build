...
function CreateInterMatch({
  ...
  const [createNewMatchInter] = useCreateNewMatchInter();
  ...
  const handleDeselect = (player) => {
    const arr = matchData.sportPlayerFree;
    const arr2 = dummyData.freeArr.filter((item) => {
      ...
      <div className={style.addDisplay}>
          ...
          <div>
            ...
            <div className={style.content}>
              ...
              <div className={style.input}>
                <h6>{t("match_name")}</h6>
                <input
                  className={style.sportEventMatchDate}
                  type="text"
                    ...
                    {matchData.sportPlayer === "" ? (
                      ...
                      >
                        <img
                          ...
                          alt=""
                          src={
                            dummyData?.player?.photoId !== 0
                              ? `${imageShowUrl}/${dummyData?.player?.studentProfilePhoto}`
                              : "/images/sports/avatar-circle.svg"
                          }
                        />
                        <div>
                          <h6>
                            {dummyData.player?.studentFirstName}{" "}
                            {dummyData.player?.studentMiddleName}
                            {dummyData.player?.studentLastName}
                          </h6>
                        </div>
                      </div>
                    )}
                    ...
                    {matchData.sportTeam === "" ? (
                      ...
                      >
                        <img
                          ...
                          alt=""
                          src={
                            dummyData?.team?.photoId !== 0
                              ? `${imageShowUrl}/${dummyData?.team?.sportTeamPhoto}`
                              : "/images/sports/avatar-circle.svg"
                          }
                        />
                        <div>
                          <h6>{dummyData.team?.sportClassTeamName}</h6>
                        </div>
                      </div>
                    )}
                  </div>
            ...
            <div className={style.content}>
              {allClassStudentList?.student_query?.map((player) => (
                <div
                  ...
                  onClick={() => {
                    setMatchData({ ...matchData, sportPlayer: player?._id });
                    setDummyData({ ...dummyData, player: player });
                    setIndex(0);
                  }}
                >
                  <img
        ...
        {index === 2 && (
          <div>
            ...
            <div className={style.content}>
              {allClassTeamList?.team_query.map((team, index) => (
                <div
                  className={style.itemmTeam}
                  onClick={() => {
                    setMatchData({ ...matchData, sportTeam: team?._id });
                    setDummyData({ ...dummyData, team: team });
                    setIndex(0);
                  }}
                >
...
export default CreateInterMatch;
