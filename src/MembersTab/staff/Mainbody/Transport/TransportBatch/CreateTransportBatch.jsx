...
import { useCreateTransportBatch } from "../../../../../hooks/member_tab/transport-api";

const CreateTransportBatch = ({
  onClose,
  onRefetch,
  openAs,
  batchMenu,
  ...
  const [createTransportBatch] = useCreateTransportBatch();
  useEffect(() => {
    if (openAs === "EDIT") {
...
export default CreateTransportBatch;
