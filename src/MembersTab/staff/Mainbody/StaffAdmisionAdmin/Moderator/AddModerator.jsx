...
import { useAddModeratorByAdmissionAdmin } from "../../../../../hooks/member_tab/admission-api";
...
const AddModerator = ({
  ...
  const [addModeratorByAdmissionAdmin] = useAddModeratorByAdmissionAdmin();
    ...
    setModeratorState((prev) => ({
      ...
      mod_role:
        val === "Fee receipt authority"
          ...
          ? "MULTI_APP_ACCESS"
          : val === "Enquiries Section"
          ? "INQUIRY_ACCESS"
          : val === "Scholarship Manager"
          ? "SCHOLARSHIP_ACCESS"
          : val === "Excess Fee Refund"
          ? "REFUND_ACCESS"
                ...
                <CustomNormalSelectInput
                  ...
                  value={
                    moderatorState?.mod_role === "ALL_FEE_ACCESS"
                      ...
                      ? "Enquiries Section"
                      : moderatorState?.mod_role === "SCHOLARSHIP_ACCESS"
                      ? "Scholarship Manager"
                      : moderatorState?.mod_role === "REFUND_ACCESS"
                      ? "Excess Fee Refund"
