...
import { useReceiptActionByAdmission } from "../../../../../hooks/member_tab/admission-api";
...
const RequestReceiptAction = ({
  ...
  const onInputChange = () => {};
  const [receiptActionByAdmission] = useReceiptActionByAdmission();
