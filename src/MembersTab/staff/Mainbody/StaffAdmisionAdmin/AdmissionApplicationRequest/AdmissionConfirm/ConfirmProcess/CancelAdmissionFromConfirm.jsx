...
import { useApplicantAdmissionCancel } from "../../../../../../../hooks/member_tab/admission-api";
...
import PaymentModeType from "../../AdmissionSelected/SelectedProcess/PaymentModeType";
import JoinFormCalender from "../../../../../../../JoiningForm/Student/Form/JoinFormCalender";

function CancelAdmissionFromConfirm({
  onRefetchWhenAction,
  applicationId,
  currentApplicant,
  onClose,
  ...
  const [cancelAppliacntAdmission] = useApplicantAdmissionCancel();
  ...
  return (
    <PopupWrapper onClose={onClose}>
      <div className={style.admission_modal}>
        ...
        />
        <div className={style.confirm_btn} onClick={onCancelAdmission}>
          {t("confirm")}
        </div>
        <Notfication
...
export default CancelAdmissionFromConfirm;
