...
import { useCreateHostelBatch } from "../../../../../hooks/member_tab/hostel-api";
import JoinFormInput from "../../../../../JoiningForm/Student/Form/JoinFormInput";

const CreateHostelBatch = ({
  onClose,
  onRefetch,
  openAs,
  batchMenu,
  ...
  const [createHostelBatch] = useCreateHostelBatch();
  useEffect(() => {
    if (openAs === "EDIT") {
...
export default CreateHostelBatch;
