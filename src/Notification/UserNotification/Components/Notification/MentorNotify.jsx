...
const MentorNotify = ({ notification }) => {
    ...
    <Link to={`/q/${params?.username}/memberstab`} style={{ width: "100%" }}>
      <div className={style.eachItem}>
        <div className={style.eachItemleft}>
          <img
            src={
              notification?.notifyByDepartPhoto?.photoId !== "1"
                ? `${imageShowUrl}/${notification?.notifyByDepartPhoto?.insProfilePhoto}`
