    ...
    <div className={style.content}>
      ...
      <div className={style.contentbody}>
        ...
        <p className={style.text}>
          ...
          inability to use, the materials on this site, even if Qviple team or
        ...
        <p className={style.text}>
          ...
          accessible from the Qviple website (which are collectively referred to
          in these Terms &amp; Conditions as the "Qviple Service").
        </p>
        <p className={style.text}>
          ...
          Qviple Service. In these Terms &amp; Conditions, "you" refers both to
        ...
        <p className={style.text}>
          3- For institute related payments enquire with institute. [What are
          institute related payments: Payments made to institute such as ID Card
          fees, admission fees or any fees directly paid to institute]
        </p>
        <p className={style.text}>
          4- Non - Institute Payments include Application fees, Purchase of
          E-content, subscription fees.
        </p>
        <p className={style.text}>
          5- For Refund: "Type Refund" (Transaction Id) in support and we will
          get back to you within 24 hours.
        </p>
        <h5 className={style.heading}>Return and Refund Policy</h5>
        <p className={style.text}>
          Thanks for shopping at Qviple. We appreciate the fact that you like to
        ...
        <p className={style.text}>
          ...
          making a purchase at Qviple, you agree to the terms along with
        ...
        <p className={style.text}>
          In return for our commitment to providing services, we require you to
          be committed to the following:
        </p>
        <h5 className={style.heading}>Who can use Qviple?</h5>
        <p className={style.text}>
          We want our service to be as free and comprehensive as possible but we
          also want it to be safe, protected and law abiding. So, we need you to
          follow some restrictions to be part of the Qviple community.
        </p>
        <ul>
          <li className={style.text}>
            You must be at least 13 years old to use Qviple Independently, or at
            least the legal age applicable in your country.
          </li>
          <li className={style.text}>
            If you are 13 years old or below then your parents should operate
            your account on your behalf or you can on your parents's permission.
          </li>
          <li className={style.text}>
            You should not be prohibited from receiving any part of our Services
            under applicable laws or be involved in payment related services if
            you are on the list of denied parties to which you apply.
          </li>
          <li className={style.text}>
            Your account violated the law or any of our policies so we must not
        ...
        <p className={style.text}>
          We need to do our part to provide a safe and free service to the wider
          community. You cannot impersonate or misrepresent others. You are not
          required to disclose your identity on Qviple but you are required to
          provide us with accurate and up-to-date information (including
          registration information), which may include providing your personal
          data. Also, you cannot impersonate another person or something that
          you are not, and you cannot create an account for them unless you have
          the express permission of another person.
        </p>
        <ul>
          <li className={style.text}>
            You may not do anything illegal, misleading or deceptive or for
          ...
          <li className={style.text}>
            ...
            policies, and (or cannot support or encourage) others to violate.
          </li>
          <li className={style.text}>
            If you post branded content, you must comply with related branded
            compliance policies of your country or that company which require
            you to use our branded content tool.
          </li>
          <li className={style.text}>
            There is nothing you can do to interfere with the purpose of the
            service or to disrupt its operation.
          </li>
          <li className={style.text}>
          ...
          <li className={style.text}>
            ...
            accounts or collecting information by automated methods without our
            explicit permission.
            <li className={style.text}>
              We may not sell, license or purchase or license any account or
              data we receive from our Services.
            </li>
            This includes attempting to buy, sell or transfer any aspects of
            your account (including username); Requesting, compiling, or using
            other users' login credentials or badges; Or requesting or compiling
            Qviple usernames, passwords, or inappropriate access tokens.
          </li>
          <li className={style.text}>
            You may not post anyone else's confidential or confidential
            information without permission or act in a way that infringes anyone
            else's rights, including intellectual property rights (e.g.
            copyright infringement, trademark infringement, forgery or unlawful
            reproduction).
          </li>
          <li className={style.text}>
            You may use the rights of someone else under the applicable laws,
            with the exception or limitation of copyright and related rights.
            Represents the ownership of all content you post or share, or the
            acquisition of all necessary rights to it including how to report
            any content that you think infringes your intellectual property
            rights.
          </li>
          <li className={style.text}>
            You may not modify, translate, create or reverse our products or
            their components.
          </li>
          <li className={style.text}>
            You may not use a domain name or URL in your username without our
            prior written consent.
          </li>
        </ul>
        <h5 className={style.heading}>The permissions you give us : </h5>
        <p className={style.text}>
          As part of your agreement, you also give us the permissions we need to
          provide the services. We do not claim ownership of your content, but
          you grant us permission to use it.
          <p className={style.text}>
            There are no changes to your rights to your content. We do not claim
            ownership of your content that you post on or through the Service,
            and you are free to share your content with anyone and whenever you
            want. However, we need some legal permissions from you to provide
            the service (known as a "license").
          </p>
          <p className={style.text}>
            When you share, post, or upload content (such as photos or videos)
            covered by or in connection with our Services, you are hereby
            hosting, using, distributing, modifying, running, and copying your
            Content. Not having a monopoly on performing, publicly presenting or
            displaying, translating and creating derivative content using your
            content (consistent with your privacy and application settings),
            Grants royalty-free, transferable, sub-licensed, worldwide licenses.
            This license will expire when your content is deleted from our
            systems. You can delete the content individually or at once by
            deleting your account.
          </p>
          <p className={style.text}>
            Permission to use your username, profile picture and information
            about your relationship and actions taken from the accounts,
            advertisements and sponsored content. Your username, profile
            picture, and information about your actions (such as liking) or
            relationships (such as following), accounts, ads, offers, and other
            sponsored content that you follow or engage in front of or related
            to, which is displayed on products. You allow us to show you without
            any compensation.
          </p>
          <p className={style.text}>
            For example, we might show that you liked a sponsored post created
            by a brand that paid us to display their ads on Qviple.
          </p>
          <p className={style.text}>
            In the case of actions on other content and follow-up on other
            accounts, actions on sponsored content and follow-up on sponsored
            accounts, this can only be seen by people who are allowed to view or
            follow that content.
          </p>
          <p className={style.text}>We also respect your ad settings.</p>
          <p className={style.text}>
            You agree that we may download and install updates to the Service on
            your device.
          </p>
        </p>
        <h5 className={style.heading}>Additional rights we reserve</h5>
        <p className={style.text}>
          If you choose a username or identical identifier for your account, we
          may change it if we deem it appropriate or necessary (for example, if
          it infringes one person's intellectual property or impersonates
          another user).
        </p>
        <p className={style.text}>
          If you use content that we have and include in our Services (for
          example, the content, images, designs, videos or sounds that you add
          to the content you create or share and we provide) But not yours)
          reserves all rights.
        </p>
        <p className={style.text}>
          You may use our intellectual property and trademarks or similar
          symbols only as expressly permitted by our brand guidelines or with
          our prior written permission.
        </p>
        <p className={style.text}>
          You must obtain written permission from us or under the Open Source
          License to modify, derive, or otherwise delete, or otherwise attempt
        ...
        <p className={style.text}>
          ...
          Service, in violation of these Terms of Use, our policies or if we are
          permitted to do so by law or if necessary. To protect our community or
          services, or if you create risk or legal contact for us, or these
          Terms of Use or our policies. In case of infringement, or if you
          repeatedly infringe the intellectual property rights of others or if
          we are permitted or required by law to do so, we will provide you with
          the entire Service or any part thereof (including disabling or
          disabling access to your Products and Company Products). Can
          immediately refuse or stop.
        </p>
        <p className={style.text}>
          We may do so if we deem it necessary to stop or change the Service,
          remove or block any content or information shared on our Services, or
          stop providing some or all of the Services in order to avoid or reduce
          the adverse effects of laws or regulations on us. When you request to
          delete content, the deletion process starts automatically within 30
          days after your request.
        </p>
        <p className={style.text}>
          Deleting content can take up to 90 days after the deletion process
          begins. Once the deletion process is turned on for such content, the
          content may not be visible to other users, but remains subject to
          these Terms of Use and our data policy. Once the content is deleted,
          it may take up to 90 days for us to back it up and remove it from the
        ...
        <ul>
          <li className={style.text}>
            When your content has been used by others under this license and
            they have not deleted it (in that case this license will continue to
            apply until that content is deleted); Or
          </li>
          <li className={style.text}>
            Due to the technical limitations of our system, it may not be
            possible to delete within 90 days, in which case, we will
            technically complete the deletion process as soon as possible; Or
          </li>
          <li className={style.text}>
            When deleting restricts our ability to:
          </li>
          <li className={style.text}>
            Investigating or identifying illegal activities and violations of
            our terms and policies (e.g., identifying or investigating the
            misuse of our products or systems);
          </li>
          <li className={style.text}>
            Protecting the safety and security of our products, systems and
            users;
          </li>
          <li className={style.text}>
          ...
          <li className={style.text}>
            Comply with the request of a judicial or administrative authority,
            law enforcement or government agency;
          </li>
          <li className={style.text}>
            In that case, the content will be retained as long as necessary for
            the purpose for which it was retained (the exact duration will vary
            from case to case).
          </li>
          <li className={style.text}>
            If you disable your account or we disable it, these terms as an
            agreement between you and us are terminated, but this section and
            the following "Your Agreement and What Happens If We Disagree"
            section terminates, even if your account is terminated, disabled or
            deleted Will apply.
          </li>
        </ul>
        ...
        <h5 className={style.heading}>Changes To Our Terms &amp; Conditions</h5>
        <p className={style.text}>
        ...
        <p className={style.text}>
          ...
          of the app. You agree that Qviple has no obligation to (i) provide any
        ...
        <p className={style.text}>
          You acknowledge and agree that Qviple shall not be responsible for any
          ...
          or any other aspect thereof. Qviple does not assume and shall not have
        ...
        <p className={style.text}>
          Termination of this Agreement will not limit any of Qviple's rights or
        ...
        <p className={style.text}>
          You agree to indemnify and hold Qviple and its parents, subsidiaries,
        ...
        <p className={style.text}>
          ...
          permitted under applicable law, Qviple, on its own behalf and on
        ...
        <p className={style.text}>
          ...
          content, or e-mails sent from or on behalf of Qviple are free of
        ...
        <p className={style.text}>
          ...
          of Qviple and any of its suppliers under any provision of this
        ...
        <p className={style.text}>
          ...
          provision of this Agreement), even if Qviple or any supplier has been
        ...
        <p className={style.text}>
          ...
          term or any other term, and Qviple's failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision.
          <br /> YOU AND Qviple AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR
        ...
        <p className={style.text}>
          The Agreement constitutes the entire agreement between you and Qviple
        ...
        <p className={style.text}>
          ...
          you use or purchase other Qviple's services, which Qviple will provide
        ...
        <p className={style.text}>
          ...
          are owned by Qviple, its licensors or other providers of such material
          and are protected by IN and international copyright, trademark,
          ...
          express prior written permission of Qviple, unless and except as is
        ...
        <p className={style.text}>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Qviple's INTELLECTUAL
          PROPERTY RIGHTS. The term “dispute” means any dispute, action, or
          other controversy between you and Qviple concerning the Services or
        ...
        <p className={style.text}>
          In the event of a dispute, you or Qviple must give the other a Notice
          ...
          Qviple will send any Notice of Dispute to you by mail to your address
          if we have it, or otherwise to your email address. You and Qviple will
          ...
          sixty (60) days, you or Qviple may commence arbitration.
        </p>
        ...
        <p className={style.text}>
          ...
          and will become the sole property of Qviple without any compensation
          or credit to you whatsoever. Qviple and its affiliates shall have no
        ...
        <p className={style.text}>
          ...
          signed by an authorized representative of Qviple. Qviple will be
          ...
          or anticipatory breach by you. Qviple operates and controls the Qviple
          Service from its offices in IN. The Service is not intended for
          distribution to or use by any person or entity in any jurisdiction or
          country where such distribution or use would be contrary to law or
          regulation. Accordingly, those persons who choose to access the Qviple
          ...
          include and incorporate the Qviple Privacy Policy) contains the entire
          understanding, and supersedes all prior understandings, between you
          and Qviple concerning its subject matter, and cannot be changed or
        ...
        <p className={style.text}>
          In no event shall Qviple be liable for any special, direct, indirect,
        ...
        <p className={style.text}>
          ...
          accessible via the Qviple Service. Without limiting the foregoing,
          Qviple specifically disclaims all warranties and representations in
          any content transmitted on or in connection with the Qviple Service or
          on sites that may appear as links on the Qviple Service, or in the
          products provided as a part of, or otherwise in connection with, the
          Qviple Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights. No oral advice or written information given by
          Qviple or any of its affiliates, employees, officers, directors,
          ...
          foregoing, Qviple does not warrant that the Qviple Service will be
          uninterrupted, uncorrupted, timely, or error-free.
        </p>
        <h5 className={style.heading}>Contact Us</h5>
        <div>
          <section className={style.text} style={{ marginBottom: "10px" }}>
          ...
          <section className={style.text} style={{ marginBottom: "10px" }}>
            <span className={style.textHeading}>Operational Address - </span>
            <span>
              Near Ashoka Construction Udyog Bhavan Sinnar, Nashik Maharashtra -
              422103
            </span>
          </section>
